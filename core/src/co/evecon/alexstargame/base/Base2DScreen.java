...
import co.evecon.alexstargame.math.MatrixUtils;
...
public class Base2DScreen implements Screen, InputProcessor {
    ...
    protected Game game;
    private Rect screenBounds; // Screen bounds in pixel
    protected Rect worldBounds; // World coordinates proection bounds
    private Rect glBounds; // gl-coordinates
