package co.evecon.alexstargame.screen;
...
import co.evecon.alexstargame.base.Base2DScreen;
import co.evecon.alexstargame.base.Font;
import co.evecon.alexstargame.math.Rect;
import co.evecon.alexstargame.math.Rnd;
import co.evecon.alexstargame.pools.BulletPool;
import co.evecon.alexstargame.pools.EnemyPool;
import co.evecon.alexstargame.pools.ExplosionPool;
import co.evecon.alexstargame.sprite.Background;
import co.evecon.alexstargame.sprite.Bullet;
import co.evecon.alexstargame.sprite.ButtonNewGame;
import co.evecon.alexstargame.sprite.Enemy;
import co.evecon.alexstargame.sprite.MainShip;
import co.evecon.alexstargame.sprite.MessageGameOver;
import co.evecon.alexstargame.sprite.Star;
import co.evecon.alexstargame.utils.EnemiesEmitter;
...
public class GameScreen extends Base2DScreen implements ActionListener {
    ...
    public void show() {
        ...
        music = Gdx.audio.newMusic(Gdx.files.internal("sounds/Imperial march.mp3"));
        explosionSound = Gdx.audio.newSound(Gdx.files.internal("sounds/explosion.wav"));
        bulletSound = Gdx.audio.newSound(Gdx.files.internal("sounds/Blaster.mp3"));
    ...
    public void checkCollisions() {
        ...
        for (Enemy enemy : enemyList) {
            ...
            float minDist = enemy.getHalfWidth() + mainShip.getHalfWidth(); // Distance from main ship for enemies bullet damage
